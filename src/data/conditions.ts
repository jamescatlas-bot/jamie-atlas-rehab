// The condition pages under /what-i-work-with/.
// Each page follows the format: H1 as outcome, H2s as questions, FAQ, CTA.
// Voice pass 10 Sep 2026 (doc 74 §4): first person, no em dashes, no banned
// words, "physical therapy"/"treat" only for what the client did elsewhere,
// 60/30-minute sessions, trainer-first closing sections.
...
export interface Condition {
  ...
  /** Related /resources/ articles or /for/ pages, rendered as "Read more" links. */
  resources?: { label: string; slug: string }[];
}
...
export const CONDITIONS: Condition[] = [
  {
    ...
    title: 'Your post-surgery recovery took you almost to the finish line. I get you the rest of the way, and then some',
    metaTitle: 'Return to Sport After Surgery: Training in Denver',
    schemaType: 'MedicalProcedure',
    metaDescription:
      'Insurance physical therapy got you to "functional." I get you back to skiing, cycling, lifting and running. One-on-one training after surgery in downtown Denver.',
    intro:
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'That is the part I do. One-on-one, 60 minutes or 30, in the studio or on Zoom, starting from your discharge and ending at your sport.',
        ],
      },
      {
        ...
        paragraphs: [
          ...
          'That reluctance is the symptom. It is not the thing to argue with. What changes it is evidence: find the edge of what feels safe, load it properly, let you feel yourself be strong there, then move the edge. Repeat until the edge is past what your sport asks of you.',
      ...
      },
      {
        ...
        paragraphs: [
          'First visit is a 30-minute assessment, $57: your history, a look at how you move, one change you can measure before you leave, and a straight conversation about your sport and your timeline. You leave with a plain read on fit and a number of sessions, not an open tab.',
          'After that it is progressive strength work built around three things: the surgery you had, the sport you want back, and the week you live in. Usually one session a week with work of your own in between.',
          '<strong>I don’t guess at when you’re ready.</strong> Load, range and confidence get tracked, you pass sport-specific benchmarks, and then you graduate. That last part is the point.',
        ],
      },
    ],
    faq: [
      {
        ...
        a: 'Most people come to me after insurance physical therapy ends, usually 2–6 months post-op. If you’re earlier than that, I’ll coordinate with your surgeon’s protocol.',
      },
      {
        q: 'Do you replace my physical therapist?',
        a: 'No. I start where physical therapy discharge ends. If you still have coverage, use it. When it runs out and you’re not back to your sport, that’s when this work makes sense.',
      },
      {
        q: 'How many sessions does it take?',
        a: 'Typically 6–8 sessions spread over 2–4 months, depending on the surgery and the sport. You’ll get a straight estimate at the first visit, not an open-ended commitment.',
      },
    ],
    related: ['masters-athlete-injuries', 'cognitive-functional-therapy'],
    nextStep: {
      heading: 'Then the training starts',
      body:
        'Benchmarks passed, you are not finished with me; you are finished with rehab. Most people who get back to their sport keep training here once or twice a week, because the thing that got them back is the thing that keeps them there. Same person, same room, now with the injury as history instead of the headline.',
      links: [
        { label: 'Personal training in downtown Denver', slug: '/personal-trainer-denver' },
        { label: 'Get better at your sport without getting hurt again', slug: '/this-is-you/worried-about-reinjury' },
      ],
    },
    resources: [{ label: 'Ski conditioning in Denver', slug: '/for/skiers' }],
  },
  {
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'Massage it, adjust it, inject it, brace it, strengthen the core. Every one of those turns the volume down for a while, and every one of them approaches your back as a piece of failing hardware. After three months, that is rarely what is going on.',
          'A back that keeps flaring is a web, and the tissue is one strand of it:' +
            '<ul>' +
            '<li>how much load your back and hips can tolerate right now</li>' +
            '<li>how you brace, guard and hold your breath when you bend</li>' +
            '<li>sleep, stress, and the weeks when both go at once</li>' +
            '<li>the movements you stopped making a year ago without noticing</li>' +
            '<li>what you believe is happening in there when it grabs</li>' +
            '</ul>',
          '<strong>Pull one strand and the web hands the pain straight back.</strong> That is not a failure of the treatments you tried. It is what happens when one thread gets worked on its own.',
        ],
      },
      {
        ...
        paragraphs: [
          ...
          'It is not fringe; the trial evidence behind CFT is on the <a href="/what-i-work-with/cognitive-functional-therapy">method page</a>.',
          'What it looks like in the room is less dramatic than it sounds. We make sense of your pain story together, properly, not as a formality. I look at the whole body, not just the sore spot, to find where the problem is being driven from. Then we go back into the movements you have been avoiding, bending, lifting, sitting, whatever yours are, in doses your system can accept. Then I make you strong there, because that is what makes the change stay.',
        ],
      },
      {
    ...
    faq: [
      {
        q: 'How is this different from the physical therapy I had?',
        a: 'Sessions are 60 minutes or 30, one-on-one, not a rushed insurance slot. The approach targets the pain system rather than just the tissue, and the endpoint is your sport and your life, not discharge paperwork. I am a personal trainer with rehab training, not a physical therapist, and nothing here goes through insurance.',
      },
      {
      ...
      },
      {
        ...
        a: 'Most clients need 6–8 sessions. Chronic, complex cases can take longer, and I’ll tell you plainly which one you are after the first assessment.',
      },
    ],
    ...
    nextStep: {
      ...
      body:
        "Getting out of pain is the first half. Most people then discover the thing they wanted was to get back to something: the bike, the trail, the barbell, a full day on their feet without bracing for it. That rebuild is training, with the back in the program rather than around it, and it is most of what I do.",
      links: [
        { label: 'Personal training for back pain', slug: '/personal-trainer-denver/back-pain' },
        { label: 'Personal training in downtown Denver', slug: '/personal-trainer-denver' },
      ],
    },
    resources: [{ label: 'Why pain flares some weeks', slug: '/resources/why-pain-flares-some-weeks' }],
  },
  {
    slug: 'sciatica',
    ...
    metaDescription:
      'Radicular leg pain that didn’t respond to chiropractic, epidurals or short-course physical therapy. Graded loading and strength work for persistent sciatica in downtown Denver.',
    intro:
      'It burns, or it shoots, or it goes numb somewhere below the knee, and it has outlasted everything you threw at it. You stretched the piriformis. You got adjusted. Maybe there was an epidural that worked for six weeks, or didn’t work at all. <strong>Sciatica that lasts is a different problem from sciatica that starts.</strong> Most plans are still aimed at the first one.',
    sections: [
      {
        ...
        paragraphs: [
          ...
          'Which is why the standard advice makes it worse without anyone noticing. Rest, avoid, wait it out: all of it lowers the threshold further. A sensitized nerve gets its tolerance back the same way everything else does, by being asked for a bit more than it did yesterday and no more than it can take.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          'Less dramatic than what you have already tried, and considerably more durable. <strong>I stop chasing the leg and start rebuilding what feeds it.</strong>',
  ...
  },
  {
    ...
    metaTitle: 'Training Through Injury for Masters Athletes, Denver',
    metaDescription:
      'Recurring injuries for athletes 40+: tendinopathy, joint pain, the boom-bust cycle. Break the pattern and keep training. One-on-one strength and rehab in downtown Denver.',
    intro:
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'What changes with age is the margin. Recovery takes longer, tissue tolerates less sloppiness, and the thing you got away with at 30 now costs you two weeks. Smaller margin, same principles.',
      ...
      },
      {
        ...
        paragraphs: [
          'It starts with the pattern, not just the flare. <strong>Fixing this week’s injury without closing the gap that produced it just buys you the next one.</strong>',
          'So I look at three things: the injury in front of us, the demands of your sport, and the training history that got you here. Then we build something that handles all three at once.',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Yes. It is personal training with a rehab specialist in the room: the strength work is sequenced around an injury, a pain system and return-to-sport benchmarks, and it carries on as ordinary hard training once those are cleared.',
      },
    ],
    related: ['post-surgical-return-to-sport', 'chronic-back-pain'],
    nextStep: {
      heading: 'Once the cycle is broken, what then?',
      body:
        'You keep lifting. The strength that closed the gap is the strength that keeps it closed, and most masters athletes who come in for an injury stay on as training clients, once or twice a week, with the sport as the goal and the joint as a line item.',
      links: [
        { label: 'Personal training over 40, 50 and 60', slug: '/personal-trainer-denver/over-40' },
        { label: 'By activity: skiers, golfers, runners and more', slug: '/for' },
      ],
    },
    resources: [{ label: 'Balance training that holds up in motion', slug: '/resources/balance-training' }],
  },
  {
    ...
    intro:
      'If you have already read the other pages on this site, this is the method underneath all of them: <strong>Cognitive Functional Therapy combined with a method known as Applied Functional Science</strong>, a system that identifies when the symptom and the cause of the pain are in different places, and how to use the whole body to create a different outcome than traditional methods. CFT works on the whole system that produces your pain, not the tissue that stopped being the story months ago: the beliefs, the guarding, the movements you dropped without noticing, the sleep and the stress that turn the volume up. It is the approach validated in the 2023 Lancet RESTORE trial, and I am one of a handful of practitioners in Colorado trained in it.',
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          'Three ways, and the first one is the one people don’t expect. <strong>It starts with your story, and the story is the work, not the paperwork.</strong>',
          ...
          '<strong>Then I add the part most CFT practitioners can’t.</strong> 25 years training Denver as a strength coach, to rebuild real capacity once the system has calmed down. Desensitizing without strengthening is temporary. Strengthening without desensitizing never gets off the ground.',
        ],
      },
      {
        heading: 'Who is it for?',
        paragraphs: [
          'Anyone whose pain outlasted the healing. <strong>Past three months, tissue-focused care has usually stopped being the right tool.</strong>',
  ...
  },
  {
    ...
    metaDescription:
      'Persistent neck pain, stiffness and headaches that came back after massage, adjustments or short-course physical therapy. Strength and graded movement, one-on-one in downtown Denver.',
    intro:
      "You're in pain, and somewhere along the way you stopped expecting anyone to fix it. Not for lack of trying: the massage, the adjustments, the scan, somebody's theory about your posture. <strong>I get it.</strong> That's exactly who this studio was built for: the people who kept looking after everything else came up short.",
    sections: [
      {
        ...
        paragraphs: [
          ...
          "A neck that keeps flaring is almost never one angry muscle waiting to be switched on or dialed down. It's a web, and your neck is one strand of it:" +
            '<ul>' +
            '<li>how much load your neck and shoulders can handle</li>' +
            '<li>how long you hold a position before anything moves</li>' +
            '<li>sleep, stress, and the weeks when both are bad at once</li>' +
            '<li>the movements you stopped making months ago without noticing</li>' +
            "<li>what you believe is going on in there</li>" +
            '</ul>',
          "<strong>Pull on one strand and the web hands the pain straight back.</strong> That's not a failure of the treatments you tried. It's what happens when a single thread gets worked in isolation.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "<strong>I work the whole web, not the sore spot.</strong> Most people feel something shift in that first visit. That's the start, not the finish; holding onto it usually takes six to eight sessions.",
        ],
      },
    ],
    faq: [
      ...
      {
        q: 'How many sessions will I need?',
        a: 'Most people land in the six to eight range. You will get a straight estimate after the first assessment, not an open-ended commitment.',
      },
    ],
    ...
    nextStep: {
      heading: 'Once the pain settles, what then?',
      body:
        "A neck that no longer hurts at rest is not the same as a neck that tolerates a long ride, an overhead session, or a full week at a desk. Building that tolerance is strength training for the neck, upper back and shoulders, and it is the second half of the job. Most people keep it going here, once or twice a week.",
      links: [
        { label: 'Personal training for desk workers', slug: '/for/desk-workers' },
        { label: 'Personal training in downtown Denver', slug: '/personal-trainer-denver' },
      ],
    },
    resources: [{ label: 'Desk posture: what matters and what doesn’t', slug: '/resources/desk-posture' }],
  },
  {
    slug: 'shoulder-pain',
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'By the time most people reach me they have been round that loop three or four times, and each lap ended with a smaller shoulder than the last. The way out is to load it at a dose it can take today, then raise that dose deliberately until it comfortably clears what you ask of it.',
        ],
      },
      {
        ...
        paragraphs: [
          ...
          'The evidence for progressive loading as a first-line approach to degenerative cuff problems is now substantial, with outcomes comparable to surgery across a good number of trials. Some shoulders do belong with a surgeon: traumatic full-thickness tears, real loss of function, a shoulder that cannot be lifted at all. If yours is one of those I will say so at the first session rather than sell you eight of them.',
        ],
      },
      {
        heading: 'Is it impingement?',
        paragraphs: [
          'That word has fallen out of use, and for a good reason. <strong>The picture of a bone pinching a tendon has not held up.</strong>',
          ...
          'What tends to be true instead is less tidy, and it is a web rather than a single fault:' +
            ...
            '<li>a movement pattern rebuilt around protecting it without your noticing</li>' +
      ...
      },
      {
        heading: 'What does the work look like?',
        paragraphs: [
          'First I find the boundary: what the shoulder tolerates right now, measured rather than guessed at. Then the program starts just inside it and moves it.',
          'Alongside that we deal with the two things that come with every long-running shoulder and get written off as side effects: the disrupted sleep, and the guarding you are no longer aware of doing.',
    ...
    faq: [
      {
        ...
        a: 'It can be a useful window: pain down far enough to start loading properly. On its own it tends to disappoint, because it does not change the capacity problem underneath. That is a conversation for you and your physician; I will work with whatever you decide.',
      },
      {
      ...
      },
      {
        ...
        a: 'Shoulders are typically slower than backs; tendons adapt at their own pace. Expect six to eight sessions with meaningful independent work between them, and a straight estimate after the first assessment.',
      },
    ],
    ...
    nextStep: {
      heading: 'Once the pain settles, what then?',
      body:
        "Shoulders are where the gap between 'not painful' and 'reliable' is widest. Pressing, swimming, throwing and carrying all ask for capacity you don't get back by becoming pain-free. You get it back by training, and that is the part that carries on here once the shoulder is quiet.",
      links: [
        { label: 'Personal training in downtown Denver', slug: '/personal-trainer-denver' },
        { label: 'Personal training over 40, 50 and 60', slug: '/personal-trainer-denver/over-40' },
      ],
    },
    resources: [{ label: 'Shoulder exercises that build tolerance', slug: '/resources/shoulder-exercises' }],
  },
  {
    slug: 'knee-pain',
    navTitle: 'Knee Pain',
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'It flares, the obvious conclusion is more rest, and the loop tightens by one notch. What breaks it is loading the knee at a dose it can handle now, then raising that dose on purpose until it clears what your week asks of it.',
        ],
      },
      {
        ...
        paragraphs: [
          ...
          'More useful than the picture: exercise is the first-line recommendation for knee osteoarthritis in essentially every major clinical guideline written, and it reliably improves both pain and function. Not as a consolation prize before the replacement; as the plan.',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Yes, on both sides of it. Going into surgery stronger is one of the better predictors of how the recovery goes, and the work afterwards is where the outcome is decided. I do a lot of the second kind.',
      },
      {
        q: 'How many sessions will I need?',
    ...
    nextStep: {
      heading: 'Once the pain settles, what then?',
      body:
        "A quiet knee on the flat is not a knee you trust on a descent, in a squat rack, or on the last day of a ski week. Closing that gap is strength training, and it is the work most people came for, whether or not they'd have said so at the start. If weight is part of the knee's story, the training and the food get handled together.",
      links: [
        { label: 'Personal training over 40, 50 and 60', slug: '/personal-trainer-denver/over-40' },
        { label: 'Lose the weight, keep the muscle', slug: '/personal-trainer-denver/glp-1' },
      ],
    },
    resources: [{ label: 'Hiking conditioning for the descent', slug: '/resources/hiking-conditioning' }],
  },
];
