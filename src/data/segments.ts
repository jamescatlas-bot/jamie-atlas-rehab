...
export const SEGMENTS: Segment[] = [
  {
    ...
    doorTitle: 'Cleared, but not feeling ready',
    ...
    whyUs: [
      ...
      "Every session is one-on-one with Jamie Atlas, Personal Trainer &amp; Rehab Specialist. 60 minutes, or 30 when that's what the work needs, at the private downtown Denver studio or on Zoom. Plenty of clients do a mix. Your rehabilitation, your training and your at-home plan are all built by the same person, so nothing gets lost in a handoff.",
  ...
  {
    slug: 'still-in-pain',
    doorTitle: "I'm hurt and I want to get better",
    ...
    whyUs: [
      ...
      "Every session is one-on-one with Jamie Atlas, Personal Trainer &amp; Rehab Specialist. 60 minutes, or 30 when that's what the work needs, at a private downtown Denver studio or on Zoom. No aides, no shared appointments, no printed sheet of exercises.",
      "And if we can't help you, we'll say so — and point you to the right person who can.",
    ],
  },
  {
    slug: 'worried-about-reinjury',
    doorTitle: 'Get better at my sport without getting hurt again',
    ...
    whyUs: [
      "This is not a gym. It's a one-on-one personal training studio with a rehab specialist in the room, which means the person writing your training plan carries 25 years training Denver plus the pain science most trainers were never taught. Your program is built around your body's history, present and future goals, and it adjusts the moment your body says something.",
      "Every session is one-on-one with Jamie Atlas, Personal Trainer &amp; Rehab Specialist. 60 minutes, or 30 when that's what the work needs, at a private downtown Denver studio or on Zoom. Your training, rehabilitation and at-home plans all come from the same brain, so nothing contradicts and nothing slips through.",
